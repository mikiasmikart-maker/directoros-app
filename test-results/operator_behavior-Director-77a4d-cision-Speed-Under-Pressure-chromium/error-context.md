...
- Name: operator_behavior.spec.ts >> DirectorOS Operator Behavior Validation >> 2. Decision Speed Under Pressure
- Location: e2e\operator_behavior.spec.ts:64:3
...
Call log:
  - waiting for locator('button:has-text("Workspace")')
