...
- Name: operator_behavior.spec.ts >> DirectorOS Operator Behavior Validation >> 3. Multi-job / Multi-state Coherence
- Location: e2e\operator_behavior.spec.ts:107:3
...
Locator: locator('text=/Inspector/i')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=/Inspector/i')
